...
if opt.doPlots:
  ...
  splinesToPlot = ['xs','br','ea'] if opt.skipVertexScenarioSplit else ['xs','br','ea', 'fracRV']
  plotSplines(fm,_outdir="%s/outdir_%s/signalFit/Plots"%(swd__,opt.ext),_nominalMass=MHNominal, splinesToPlot=splinesToPlot)
